      ...
      <div className="container py-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
          ...
          <div className="grid grid-cols-3 gap-4 w-full max-w-[300px]">
            ...
            >
              <SiLeetcode className="w-6 h-6 hover:text-emerald-400 transition" />
            </Link>
            <Link
              target="_blank"
              rel="noopener noreferrer"
              href="https://www.linkedin.com/in/kjangid897"
            >
              <LogoLinkedin className="w-6 h-6 hover:text-emerald-400 transition" />
            </Link>
            <Link
              target="_blank"
              rel="noopener noreferrer"
            ...
            >
              <SiGithub className="w-6 h-6 hover:text-emerald-400 transition" />
            </Link>
            <Link
              target="_blank"
              rel="noopener noreferrer"
            ...
            >
              <SiStackoverflow className="w-6 h-6 hover:text-emerald-400 transition" />
            </Link>
          </div>
        </div>
      </div>
